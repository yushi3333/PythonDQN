...
# Adding CARLA PythonAPI path
carla_api_path = "C:/Users/a1125/Desktop/CARLA_0.9.11/WindowsNoEditor/PythonAPI/carla"
carla_egg_path = "C:/Users/a1125/Desktop/CARLA_0.9.11/WindowsNoEditor/PythonAPI/carla/dist/carla-0.9.11-py3.7-win-amd64.egg"
...
class DQN(object):
    ...
    def compute_loss(self, replay_buffer):
        ...
        # Get current Q estimate from the main Q network
        current_Q = self.Q(state).gather(1, action)

        # Compute the Q loss using Smooth L1 loss (Huber loss)
        Q_loss = F.smooth_l1_loss(current_Q, target_Q)
